...
const getTransactionReceiptBatched = require("../../ropsten/grocery-shop/functions/getTransactionReceiptBatched");

const tokenTransferHexSignature = "0xa9059cbb";

let rpc = "<RPC_URL>"; // PLASMA CHAIN (e.g. Polygon)
